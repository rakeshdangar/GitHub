...
using LocalNews.Filters;
using LocalNews.BusinessLogic.Bll;
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Manage(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : "";
            ViewBag.HasLocalPassword = userBll.HasLocalAccount(User.Identity.Name);
        ...
        public ActionResult Manage(LocalPasswordModel model)
        {
            ...
            if (hasLocalAccount)
            {
                if (ModelState.IsValid)
                {
                    ...
                    try
                    {
                        changePasswordSucceeded = userBll.ChangePassword(User.Identity.Name, model.OldPassword, model.NewPassword);
                    }
                    catch (Exception)
                    {
        ...
        public ActionResult RemoveExternalLogins()
        {
            ...
            ViewBag.ShowRemoveButton = externalLogins.Count > 1 || userBll.HasLocalAccount(User.Identity.Name);
